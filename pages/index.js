  ...
  return (
    <>
      <div className="container">
        ...
        <p className="text-center mb-4 text-[#5BC9B4]">Welcome to your dashboard</p>
        <div className="flex flex-wrap justify-between space-y-4 sm:space-y-0 text-center">
          <div className="bg-[#1F2A40] px-5 py-4 w-full sm:w-1/2 md:w-1/4 lg:w-1/5">
